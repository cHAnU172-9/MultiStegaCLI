...
STEGO_IMAGE_FILEPATH = "out.jpeg"
SECRET_MESSAGE_STRING = sys.argv[2]
password = sys.argv[3]

#NUM_CHANNELS = 3
#COVER_IMAGE_FILEPATH  = "./download.jpeg" # Choose your cover image (PNG)
#STEGO_IMAGE_FILEPATH  = "./out_stego.jpeg"
...
f = open(SECRET_MESSAGE_STRING, "rb")
data = f.read()
f.close()
...
for chan_index in range(NUM_CHANNELS):
    ...
    if (chan_index == 0):
        ...
        secret_data = ""
        for char in data_enc: secret_data += bitstring.pack('uint:8', char)
